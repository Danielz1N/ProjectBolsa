  ...
  <body data-spy="scroll" data-offset="0" data-target="#navbar-main">
    ...
    <style type="text/css">
      #div_form{
        ...
        <form id='form1'class="form-horizontal" method="POST" action = "att_items.php">
          ...
          <input style= "margin-bottom:2.5%;margin-left:270px;width: 600px" type="text" class="form-control" name = "descricao" id="descricao" placeholder="Descricão do Item">

          <button id= center-button-clear type="reset" style="margin-top: 50px;margin-right: 30px" class="btn btn-reset">Limpar</button>
          <input style= 'margin-top: 50px;'type="button" onclick="verify()" id="center-button-submit" name="insert" class="btn btn-success" value="Atualizar">
        </form>
      </div>
		</div><!-- container -->
   ...
   function change_instru(){
    ...
    function verify(){
      ...
      if(instru != "Instrumento de Avaliação" && descricao != "" &&  n_dim != "Dimensão" && order_item != "Ordem do Item"){
