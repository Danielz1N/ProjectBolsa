...
<html lang="pt-BR">
  ...
  <body data-spy="scroll" data-offset="0" data-target="#navbar-main">
    ...
    <style type="text/css">
      #div_form{
        ...
        <form id='form1' class="form-horizontal" method="POST" action="insert_curso.php">
          ...
          <select style="margin-bottom:2.5%;width: 600px;margin-left: 260px"class="form-control" name="unid_acad" id="unid_acad">
            <option hidden >Unidade Acadêmica</option>
          </select>

          <input style= "margin-bottom:8%;margin-left:260px;width: 600px" type="text" class="form-control" name = "curso" id="curso" placeholder="Nome do Novo Curso">
  ...
  <script type="text/javascript">
    ...
    function verify(){
      ...
      var input = document.getElementById("curso").value;
