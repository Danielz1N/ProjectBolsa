  ...
  <body data-spy="scroll" data-offset="0" data-target="#navbar-main">
    ...
    <style type="text/css">
      #div_form{
        ...
        <h3>Cadastro de Unidade Acadêmica</h3>
        <form id='form1' class="form-horizontal" method="POST" action="insert_unid_acad.php">
          
          <select autofocus style="margin-top:10%;margin-bottom:2.5%;width: 600px;margin-left: 260px" class="form-control" name="campus" id="campus">
          ...
          <input style= "margin-bottom:8%;margin-left:260px;width: 600px" type="text" class="form-control" name = "unid_acad" id="unid_acad" placeholder="Nome da Nova Unidade Acadêmica">
   ...
   function verify(){
      ...
      var input = document.getElementById("unid_acad").value;
