            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                  <li><a href="../atualizar/campus.php">Campus</a></li>
                  <li role="separator" class="divider"></li>
                  <li><a href="../atualizar/unid_acad.php">Unidade Acadêmica</a></li>
                  <li role="separator" class="divider"></li>
                  <li><a href="../atualizar/curso.php">Curso</a></li>
                  <li role="separator" class="divider"></li>
                  <li><a href="../atualizar/instru_avaliacao.php">Instrumento de Avaliação</a></li>
                  <li role="separator" class="divider"></li>
                  <li><a href="../atualizar/dimensoes.php">Dimensão</a></li>
                  <li role="separator" class="divider"></li>
                  <li><a href="../atualizar/items.php">Item</a></li>
                </ul>
              </li>
              <li class="dropdown">
