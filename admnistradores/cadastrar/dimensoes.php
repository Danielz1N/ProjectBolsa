  ...
  <body data-spy="scroll" data-offset="0" data-target="#navbar-main">
    ...
    <style type="text/css">
      #div_form{
        ...
        <h3>Cadastro de Dimensões</h3>
        <form id='form1'class="form-horizontal" method="POST" action="insert_dimensoes.php">

          <select autofocus style="margin-top:10%;margin-bottom:2.5%;width: 600px;margin-left: 260px" class="form-control" name="instrumento" id="instrumento">
   ...
   function verify(){
      ...
      if(instrumento != "Instrumento de Avaliação" && descricao != "" && n_dim != "" && order_dim != ""){
