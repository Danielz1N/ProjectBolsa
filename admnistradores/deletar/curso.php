...
<html lang="pt-BR">
  ...
  <body data-spy="scroll" data-offset="0" data-target="#navbar-main">
    ...
    <style type="text/css">
      #div_form{
        ...
        <h3>Deletar Curso</h3>
        <form id='form1'class="form-horizontal" method="POST" action="del_curso.php">
          ...
          <select style="margin-bottom:2.5%;width: 600px;margin-left: 270px"class="form-control" name="curso" id="curso">
  ...
  <script type="text/javascript">
    ...
    function verify(){
      ...
      if(campus != "Campus" && unid_acad != "Unidade Acadêmica" && curso != "Curso"){
