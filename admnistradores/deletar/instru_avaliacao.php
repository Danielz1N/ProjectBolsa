...
<html lang="pt-BR">
  ...
  <body data-spy="scroll" data-offset="0" data-target="#navbar-main">
    ...
    <br>
        ...
        <br><br>
        <h3>Deletar Instrumento de Avaliação</h3>
        <form id='form1'class="form-horizontal" method="POST" action="del_instru_avaliacao.php">
          
          <select autofocus style="margin-top:13%;margin-bottom:15%;width: 600px;margin-left: 260px" class="form-control" name="instru_aval" id="instru_aval">
    ...
    function verify(){
      var instru_aval = document.getElementById("instru_aval").value;
      if(instru_aval != "Instrumento de Avaliação"){
